...
C:\Windows\System32\wsl.exe helm plugin install https://github.com/aslafy-z/helm-git --version 0.10.0
C:\Windows\System32\wsl.exe helm repo add bitnami https://charts.bitnami.com/bitnami
C:\Windows\System32\wsl.exe helm repo update
C:\Windows\System32\wsl.exe sudo helm dependency update
